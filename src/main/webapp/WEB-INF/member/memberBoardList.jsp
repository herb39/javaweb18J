...
<script>
    ...
    function pageCheck() {
    	...
    	location.href = "${ctp}/MemberBoardList.mem?pag=${pag}&pageSize="+pageSize;
    }
...
<p><br/></p>
<div class="container">
  <h2 class="text-center">${sNickName} 님의 게시글 리스트</h2>
  <table class="table table-borderless mb-0 p-0">
    <tr>
      <td colspan="2" style="text-align:right;"><a href="${ctp}/BoardList.bo" class="btn btn-primary btn-sm">게시판으로 이동</a></td>
    </tr>
  </table>
  <table class="table table-borderless mb-0 p-0">
    <tr>
