...
<div class="container">
  ...
  <table class="table table-borderless m-0 p-0">
  	<tr>
  		<td><a href="${ctp}/Board1List.tsb?pag=${pag}&pageSize=${pageSize}" class="btn btn-info btn-sm">돌아가기</a></td>
  	</tr>
  </table>
  <table class="table table-hover text-center">
    ...
    <c:if test="${vo.day_diff == 0}">
      <tr>
        <td>${searchCount}</td>
        <td>
        	<a href="${ctp}/Board1Content.tsb?flag=search&search=${search}&searchString=${searchString}&idx=${vo.idx}&pag=${pag}&pageSize=${pageSize}">${vo.title}</a>
